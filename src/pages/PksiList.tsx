...
const transformApiData = (apiData: PksiDocumentData): PksiData => {
  ...
  return {
    ...
    // Timeline - use grouped timelines (all 9 stages)
...
function PksiList() {
  ...
  // Timeline column visibility configuration
  const [timelineColumnsAnchorEl, setTimelineColumnsAnchorEl] = useState<null | HTMLElement>(null);
  const [visibleTimelineColumns, setVisibleTimelineColumns] = useState<Set<string>>(new Set(['usreq', 'sit', 'uat', 'goLive']));
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            ...
            <Box
              sx={{
                ...
                alignItems: 'center',
                gap: 1,
                bgcolor: selectedYearFilter ? 'rgba(189, 31, 39, 0.08)' : '#F1F5F9',
                borderRadius: '12px',
                px: 1.5,
                py: 0.5,
        ...
        >
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    ...
                    size="small"
                    disabled={visibleTimelineColumns.has(col.id) && visibleTimelineColumns.size === 1}
                    sx={{
          ...
          <Box sx={{ display: 'flex', gap: 1, mt: 1 }}>
            ...
            <Button
              ...
              variant="text"
              size="small"
              onClick={() => setVisibleTimelineColumns(new Set(TIMELINE_COLUMN_OPTIONS.map(c => c.id)))}
          ...
          <Table sx={{ minWidth: 1800 }}>
            <TableHead>
              ...
              <TableRow sx={{ bgcolor: '#FFFFFF' }}>
                ...
                <TableCell rowSpan={2} sx={{ fontWeight: 600, color: '#334155', py: 1.5, px: 2, whiteSpace: 'nowrap', fontSize: '0.8rem', minWidth: 90, textAlign: 'left', ...(stickyColumns.has('skpa') && { position: 'sticky', left: getStickyLeft('skpa'), zIndex: 3, bgcolor: '#FFFFFF' }), ...(isLastStickyColumn('skpa') && { boxShadow: '2px 0 5px -2px rgba(0,0,0,0.1)' }) }}>
                  SKPA
                </TableCell>
              ...
              {isLoading ? (
                ...
                >
                  ...
                  <TableCell sx={{ 
                    ...
                    wordWrap: 'break-word',
                    minWidth: 150,
                    textAlign: 'left', ...(stickyColumns.has('namaAplikasi') && { position: 'sticky', left: getStickyLeft('namaAplikasi'), zIndex: 1, bgcolor: '#fff' }),
                  ...
                  <TableCell sx={{ 
                    ...
                    wordWrap: 'break-word',
                    minWidth: 200,
                    textAlign: 'left', ...(stickyColumns.has('namaPksi') && { position: 'sticky', left: getStickyLeft('namaPksi'), zIndex: 1, bgcolor: '#fff' }),
                  ...
                  <TableCell sx={{
                    ...
                    px: 1,
                    minWidth: 90,
                    textAlign: 'left', ...(stickyColumns.has('skpa') && { position: 'sticky', left: getStickyLeft('skpa'), zIndex: 1, bgcolor: '#fff' }),
