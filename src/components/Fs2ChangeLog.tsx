...
import { getFs2Changelogs } from '../api/fs2Api';
...
const Fs2ChangeLog: React.FC<Fs2ChangeLogProps> = ({ fs2Id, changeLogs }) => {
  ...
  useEffect(() => {
    const fetchChangelogs = async () => {
      ...
      setIsLoading(true);
      try {
        const response = await getFs2Changelogs(fs2Id);
